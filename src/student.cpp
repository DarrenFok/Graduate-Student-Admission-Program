...
//                                      Domestic insert
//-------------------------------------------------------------------------------------------------
bool DomesticList::createTestNormal(){
    //fields
    string firstInput; string lastInput; string researchInput; string cgpaInput; string provinceInput;
    cout <<"\nTesting Normal Domestic Cases for Inserting Student\n";
    cout <<"Normal Case: Firstname, Lastname, 100, 4.0, BC\n";
    //cases
...
bool DomesticList::createTestCorner(){
    //fields
    string firstInput; string lastInput; string researchInput; string cgpaInput; string provinceInput;
    cout <<"\nTesting Corner Domestic Cases for Inserting Student\n";
    cout <<"Corner Case: FiRstNaMe, LaStnAme, 1, 4.02, BC\n";
    //cases
    firstInput = "FiRstNaMe";
    lastInput = "LaStnAme";
    researchInput = "1";
...
bool DomesticList::createTestIllegal(){
    //fields
    string firstInput; string lastInput; string researchInput; string cgpaInput; string provinceInput;
    cout <<"\nTesting Illegal Domestic Cases for Inserting Student\n";
    cout <<"Illegal Case: Firstname, Lastname, 101, 8.33, FAKEPROVINCE\n";
    //cases
    firstInput = "Firstname";
    lastInput = "Lastname";
    researchInput = "101";
    cgpaInput = "8.33";
    provinceInput = "FAKEPROVINCE";
...
//                                      Domestic SearchOne
void DomesticList::searchOneNormal() const {
    string inputSearchOne1;
    cout << "Please input number corresponding to which field you would like to search" << endl;
    cout << "1) CGPA" << endl;
    cout << "2) Research Score" << endl;
    ...
    if(isNumerical(inputSearchOne1) == false){
        ...
        if(stoi(inputSearchOne1) == 1){ //cgpa is data type double, NEED TO CREATE A FUNCTION TO CHECK IF VALID DOUBLE
            ...
            int count = 0;
            //case
            cout << "Testing Normal Case for Domestic Search cgpa: 4.00" << endl;
            inputSearchOne2 = "4.00";
            //print the ones that meet the requirement
            DomesticStudent *temp = head;
            if(isDouble(inputSearchOne2) == false){ //checks whether inputSearchOne2 is a double
                cout << "ERROR: Invalid input, doubles accepted only" << endl;
            ...
            string inputSearchOne2;
            int count = 0;
            cout << "Testing Normal Case for Domestic Search research score: 100" << endl;
            inputSearchOne2 = "100";
            DomesticStudent *temp = head;
            if(isNumerical(inputSearchOne2) == false){
                cout << "ERROR: Invalid input, integers accepted only" << endl;
            ...
            string inputSearchOne2;
            int count = 0;
            cout << "Testing Normal Case for Domestic Search ID: 20220038" << endl;
            inputSearchOne2 = "20220038";
            DomesticStudent *temp = head;
            if(isNumerical(inputSearchOne2) == false){
                cout << "ERROR: Invalid input, integers accepted only" << endl;
            }
...
void DomesticList::searchOneCorner() const {
    string inputSearchOne1;
    cout << "Please input number corresponding to which field you would like to search" << endl;
    cout << "1) CGPA" << endl;
    cout << "2) Research Score" << endl;
    ...
    if(isNumerical(inputSearchOne1) == false){
        ...
        if(stoi(inputSearchOne1) == 1){ //cgpa is data type double, NEED TO CREATE A FUNCTION TO CHECK IF VALID DOUBLE
            ...
            int count = 0;
            //case
            cout << "Testing Corner Case for Domestic Search cgpa: 5.00" << endl;
            inputSearchOne2 = "5.00";
            //print the ones that meet the requirement
            DomesticStudent *temp = head;
            if(isDouble(inputSearchOne2) == false){ //checks whether inputSearchOne2 is a double
                cout << "ERROR: Invalid input, doubles accepted only" << endl;
            ...
            string inputSearchOne2;
            int count = 0;
            cout << "Testing Corner Case for Domestic Search research score: 120" << endl;
            inputSearchOne2 = "120";
            DomesticStudent *temp = head;
            if(isNumerical(inputSearchOne2) == false){
                cout << "ERROR: Invalid input, integers accepted only" << endl;
            ...
            string inputSearchOne2;
            int count = 0;
            cout << "Testing Normal Case for Domestic Search ID: 20210069" << endl;
            inputSearchOne2 = "20210069";
            DomesticStudent *temp = head;
            if(isNumerical(inputSearchOne2) == false){
                cout << "ERROR: Invalid input, integers accepted only" << endl;
            }
...
void DomesticList::searchOneIllegal() const {
    string inputSearchOne1;
    cout << "Please input number corresponding to which field you would like to search" << endl;
    cout << "1) CGPA" << endl;
    cout << "2) Research Score" << endl;
    ...
    if(isNumerical(inputSearchOne1) == false){
        ...
        if(stoi(inputSearchOne1) == 1){ //cgpa is data type double, NEED TO CREATE A FUNCTION TO CHECK IF VALID DOUBLE
            ...
            int count = 0;
            //case
            cout << "Testing Illegal Case for Domestic Search cgpa: four" << endl;
            inputSearchOne2 = "four";
            //print the ones that meet the requirement
            DomesticStudent *temp = head;
            if(isDouble(inputSearchOne2) == false){ //checks whether inputSearchOne2 is a double
                cout << "ERROR: Invalid input, doubles accepted only" << endl;
            ...
            string inputSearchOne2;
            int count = 0;
            cout << "Testing Illegal Case for Domestic Search research score: Million" << endl;
            inputSearchOne2 = "Million";
            DomesticStudent *temp = head;
            if(isNumerical(inputSearchOne2) == false){
                cout << "ERROR: Invalid input, integers accepted only" << endl;
            }
            ...
            string inputSearchOne2;
            int count = 0;
            cout << "Testing Normal Case for Domestic Search ID: Fourty" << endl;
            inputSearchOne2 = "FOURTY";
            DomesticStudent *temp = head;
            if(isNumerical(inputSearchOne2) == false){
                cout << "ERROR: Invalid input, integers accepted only" << endl;
            }
...
void DomesticList::searchTwoNormal() const {
    string firstNameInput;
    string lastNameInput;
    int count = 0;
    cout << "Testing Normal Case for Searchtwo: Liam Edwards" << endl;
    firstNameInput = "Liam";
    lastNameInput = "Edwards";
    DomesticStudent *temp = head;
    while(temp!= NULL){
        if((toLowerCase(temp->getFirstName()) == toLowerCase(firstNameInput)) && (toLowerCase(temp->getLastName()) ==
                toLowerCase(lastNameInput))){
...
void DomesticList::searchTwoCorner() const {
    string firstNameInput;
    string lastNameInput;
    int count = 0;
    cout << "Testing Corner Case for Searchtwo: Fake Name" << endl;
    firstNameInput = "Fake";
    lastNameInput = "Name";
    DomesticStudent *temp = head;
    while(temp!= NULL){
...
void DomesticList::searchTwoIllegal() const {
    string firstNameInput;
    string lastNameInput;
    int count = 0;
    cout << "Testing Illegal Case for Searchtwo: 1 2" << endl;
    firstNameInput = "1";
    lastNameInput = "2";
    DomesticStudent *temp = head;
    while(temp!= NULL){
...
//                                      Domestic Delete
void DomesticList::selectDeleteNormal(){
    DomesticStudent* before = head;
    DomesticStudent* current = head; //node that we want to delete
    int count = 0;
    string firstnameInput;
    string lastnameInput;
    //get user input
    cout << "\nTesting Normal case for Deleting Domestic Student: Violet Simmons" << endl;
    firstnameInput = "Violet";
    lastnameInput = "Simmons";
...
void DomesticList::selectDeleteCorner(){
    DomesticStudent* before = head;
    DomesticStudent* current = head; //node that we want to delete
    int count = 0;
    string firstnameInput;
    string lastnameInput;
    //get user input
    cout << "\nTesting Corner case for Deleting Domestic Student: lIAm eDwArDs" << endl;
    firstnameInput = "lIAm";
    lastnameInput = "eDwArDs";
...
void DomesticList::selectDeleteIllegal(){
    DomesticStudent* before = head;
    DomesticStudent* current = head; //node that we want to delete
    int count = 0;
    string firstnameInput;
    string lastnameInput;
    //get user input
    cout << "\nTesting Illegal case for Deleting Domestic Student: 1 2" << endl;
    firstnameInput = "1";
    lastnameInput = "2";
...
bool MergeList::searchNormal() const{
    string cgpa_threshold; string researchScore_threshold;
    int count = 0;
    cout << "\nTesting Normal Case for Merged search:" << endl;
    cout <<"Research Score threshold: 100   CGPA threshold: 4.33\n";
...
bool MergeList::searchCorner() const{
    string cgpa_threshold; string researchScore_threshold;
    int count = 0;
    cout << "\nTesting Corner Case for Merged search:" << endl;
    cout <<"Research Score threshold: -50   CGPA threshold: -1.00\n";
    researchScore_threshold = "-50";
    if(isNumerical(researchScore_threshold) == false){
        cout << "ERROR: Invalid input, integers accepted only" << endl;
        return false;
    }
...
bool MergeList::searchIllegal() const{
    string cgpa_threshold; string researchScore_threshold;
    int count = 0;
    cout << "\nTesting Illegal Case for Merged search:" << endl;
    cout <<"Research Score threshold: onehundred   CGPA threshold: four\n";
    researchScore_threshold = "onehundred";
    if(isNumerical(researchScore_threshold) == false){
        cout << "ERROR: Invalid input, integers accepted only" << endl;
        return false;
    }
